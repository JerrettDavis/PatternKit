...
| -------------- |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Creational** | [Factory](docs/patterns/creational/factory/factory.md) ✓ • [Composer](docs/patterns/creational/builer/composer.md) ✓ • [ChainBuilder](docs/patterns/creational/builer/chainbuilder.md) ✓ • [BranchBuilder](docs/patterns/creational/builer/chainbuilder.md) ✓ • [MutableBuilder](docs/patterns/creational/builer/mutablebuilder.md) ✓ • [Prototype](docs/patterns/creational/prototype/prototype.md) ✓ • [Singleton](docs/patterns/creational/singleton/singleton.md) ✓                                              |
