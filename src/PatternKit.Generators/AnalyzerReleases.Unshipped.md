...
PKCI001 | PatternKit.Generators.Messaging | Error | Correlation identifier host must be partial
PKCI002 | PatternKit.Generators.Messaging | Error | Correlation identifier configuration is invalid
