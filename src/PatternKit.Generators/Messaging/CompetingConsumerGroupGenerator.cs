...
public sealed class CompetingConsumerGroupGenerator : IIncrementalGenerator
{
        ...
        int maxConcurrentDeliveries)
    {
        ...
        sb.Append(memberIndent).Append("public static global::PatternKit.Messaging.CompetingConsumers.CompetingConsumerGroup<").Append(messageTypeName).Append(", ").Append(resultTypeName).Append(">.Builder ").Append(factoryMethodName).AppendLine("()");
        sb.AppendLine(memberIndent + "{");
        sb.Append(bodyIndent).Append("return global::PatternKit.Messaging.CompetingConsumers.CompetingConsumerGroup<").Append(messageTypeName).Append(", ").Append(resultTypeName).Append(">.Create(\"").Append(Escape(groupName)).AppendLine("\")");
        sb.Append(bodyIndent).Append("    .WithMaxConcurrentDeliveries(").Append(maxConcurrentDeliveries).AppendLine(");");
        sb.AppendLine(memberIndent + "}");
        sb.AppendLine(indent + "}");
